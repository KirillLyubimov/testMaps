/*! react-maps-google v0.4.1 | (c) 2020 Ryan Hefner | MIT License | https://github.com/ryanhefner/react-maps-google !*/
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom'], factory) :
	(global = global || self, factory(global['react-maps-google'] = {}, global.React, global.ReactDOM));
	...
	*/
	...
	var Circle = /*#__PURE__*/function (_Component) {
	  ...
	  _proto.renderCircle = function renderCircle(props) {
	    ...
	    if (!this.circle) {
	      this.circle = new google.maps.Circle(_objectSpread({}, Object.assign({}, defaultOptions, options), {
	        map: map,
	        center: center,
	        radius: radius
	      }));
	    ...
	    this.circle.setOptions(_objectSpread({}, Object.assign({}, defaultOptions, options), {
	      map: map,
	      center: center,
	      radius: radius
	    }));
	...
	var Marker = /*#__PURE__*/function (_Component) {
	  _inheritsLoose$1(Marker, _Component);
	  ...
	  _proto.renderMarker = function renderMarker(props) {
	    ...
	    if (!this.marker) {
	      this.marker = new google.maps.Marker(_objectSpread$1({}, options, {
	        map: map,
	        position: position
	      }));
	    ...
	    this.marker.setOptions(_objectSpread$1({}, options, {
	      map: map,
	      position: position
	    }));
	  };
	...
	var MarkerClusterer = /*#__PURE__*/function (_Component) {
	  _inheritsLoose$2(MarkerClusterer, _Component);
	...
	var GoogleMap = /*#__PURE__*/function (_Component) {
	  _inheritsLoose$3(GoogleMap, _Component);
	  ...
	  function GoogleMap(props) {
	    ...
	    _this.onScriptInit = _this.onScriptInit.bind(_assertThisInitialized$1(_this));
	  ...
	  _proto.renderMap = function renderMap() {
	    ...
	    Object.keys(CALLBACK_MAP$2).forEach(function (key) {
	      google.maps.event.addListener(map, key, _this2.onMapCallback.bind(_this2, CALLBACK_MAP$2[key]));
	    });
	    this.setState({
	      map: map
	    });
	  ...
	  _proto.render = function render() {
	    ...
	    var clonedChildren = React__default.Children.toArray(children).map(function (child) {
	      return React__default.cloneElement(child, {
	        map: map
	      });
	    });
	    return React__default.createElement(React__default.Fragment, null, scriptLoaded === false && React__default.createElement(Script, {
	    ...
	    }), React__default.createElement("div", _extends({}, cleanProps(this.props, EXCLUDE_PROPS), {
